...
# %%
movies = pd.read_csv(r'D:\Movie-Recommendation-main-main-main\Movie-Recommendation-main-main-main\\movies.csv')
genome_scores = pd.read_csv(r'D:\Movie-Recommendation-main-main-main\Movie-Recommendation-main-main-main\\links.csv')
tags = pd.read_csv(r'D:\Movie-Recommendation-main-main-main\Movie-Recommendation-main-main-main\\tags.csv')
genome_tags = pd.read_csv(r'D:\Movie-Recommendation-main-main-main\Movie-Recommendation-main-main-main\\links.csv')
ratings = pd.read_csv(r'D:\Movie-Recommendation-main-main-main\Movie-Recommendation-main-main-main\\ratings.csv')
